...
public class CorsFilter implements Filter {
     ...
     * it must first pass through any and all com.revature.filters
     * These com.revature.filters can manipulate the request/response as needed
     *
     * In this particular case, we will be adding certain headers required to allow Cross
     * Origin requests
     *
     * However, we can have com.revature.filters to detect certain requests, and perhaps deny them
